...
const ThemeMenu = () => {
  ...
  useEffect(() => {
    const themeClass = mode_settings.find(
      (el) => el.class === localStorage.getItem("themeMode", "theme-mode-light")
    );
    const colorClass = color_settings.find(
      (el) => el.class === localStorage.getItem("colorMode", "theme-mode-light")
    );
        ...
        <div className="theme-menu__select">
          ...
          <ul className="mode-list">
            {mode_settings.map((item, index) => (
              <li key={index} onClick={() => updateMode(item)}>
                <div
        ...
        <div className="theme-menu__select">
          ...
          <ul className="mode-list">
            {color_settings.map((item, index) => (
              <li key={index} onClick={() => updateColor(item)}>
                <div
                  className={`mode-list__color ${item.background} ${
